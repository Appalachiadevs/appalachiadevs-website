                        ...
                        <div className="w-full px-4 lg:w-6/12">
                            ...
                            font-bold leading-snug sm:text-[42px] lg:text-[40px] xl:text-[42px]">
                                        ...
                                        <span className="sm:text-7xl text-6xl xl:my-40 ">
                                            <span className='text-blue-500 cursor-pointer my-40'>AppalachiaDevs</span> <br />
                                        </span>
                                        <br />
                                        <span className="sm:text-3xl text-6xl mt-10">
                                            AI, IoT, and IT Consulting Services
                                        </span>

                                    </h1>
                                    <p className="text-gray-500 text-sm my-8 max-w-[480px] sm:text-base">
                                        At Appalachiadevs, we work with both businesses and individuals to bring ideas to life.
                                        Whether it’s AI agents, automation, IoT devices, or IT consulting, we provide smart
                                        solutions that make your digital projects run smoother and smarter.
                                    </p>
                                </motion.div>
                                <motion.div
                                    variants={{
                                ...
                                >
                                    <ul className="flex flex-wrap items-center">
                                        <li>
                                            <Link
                                                to="https://cal.com/appalachiadev/15min"
