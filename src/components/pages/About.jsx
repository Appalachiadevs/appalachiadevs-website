...
import AppalachiaDevs from '../images/About/SabMedia.png';
          ...
          <div className="flex flex-wrap items-center -mx-4">
            <motion.div
              ...
              <p className="text-lg text-gray-500">
                The name reflects Appalachian roots; we’re headquartered in Miami, Florida and work with clients across the U.S.
                Distance doesn’t change how we ship—clear specs, steady communication, and code you can own.
              </p>
            </motion.div>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-7/12 ">
              <motion.div
                ...
                <p className="mb-8 text-base text-gray-500">
                  "At AppalachiaDevs, we are passionate about crafting exceptional web solutions that drive digital success.
          ...
          <div className="flex flex-row flex-wrap-reverse justify-center mt-8">
            <motion.div
              ...
              <div className="flex-1 my-4">
                <p className="text-xl font-semibold leadi">Alexander Southern</p>
                <p>CEO</p>
              </div>
              <div className="flex items-center justify-center p-3 space-x-3 border-t-2 border-blue-500">
                <a rel="noopener noreferrer" href="mailto:alex@appalachiadevs.com" title="Email" className="dark:text-blue-500 hover:scale-150 transition ease-in-out">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                  </svg>
                </a>
                <a rel="noopener noreferrer" href="https://x.com/Appalachiadevs" title="Twitter" className="dark:text-blue-500 hover:scale-150 transition ease-in-out">
                ...
                <a rel="noopener noreferrer" href="https://www.linkedin.com/in/alexander-southern-67b9483b2/" title="LinkedIn" className="dark:text-blue-500 hover:scale-150 transition ease-in-out">
                ...
                <a rel="noopener noreferrer" href="https://github.com/Appalachiadevs" title="GitHub" className="dark:text-blue-500 hover:scale-150 transition ease-in-out">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5">
