...
const teamImages = [profile4, profile2];
        ...
        <div className="container mx-auto px-10">
          <div className="flex flex-wrap items-center -mx-4">
            ...
            >
              ...
              <p className="text-lg text-gray-500">{t("about.whyLead")}</p>
            </motion.div>
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-7/12 ">
              ...
              >
                ...
                <p className="mb-8 text-base text-gray-500">{t("about.body")}</p>
                <Link
                  to={p("/contact")}
      ...
      <section className="lg:pt-[100px] pb-12 lg:pb-[90px] overflow-hidden bg-gradient-to-tr from-blue-100">
        <div className="container flex flex-col items-center justify-center p-4 mx-auto sm:p-10">
          ...
          >
            ...
            <p className="text-lg text-gray-500">{t("about.teamLead")}</p>
          </motion.div>
          <div className="flex flex-row flex-wrap-reverse justify-center mt-8 gap-6">
              ...
              >
                ...
                <div className="flex items-center justify-center p-3 space-x-3 border-t-2 border-blue-500">
                  <a
                    ...
                    href="mailto:alex@appalachiadevs.com"
                    title={t("about.a11y.email")}
                  ...
                  <a
                    rel="noopener noreferrer"
                    href="https://www.linkedin.com/in/alexander-southern-67b9483b2/"
                    title={t("about.a11y.linkedin")}
                    className="dark:text-blue-500 hover:scale-150 transition ease-in-out"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="flex items-center justify-center p-3 border-t-2 border-blue-500 min-h-[3rem]" aria-hidden />
                )}
              </motion.div>
            ))}
          </div>
